...
//				mazes[level].printSc();  //We call the print function for the required level
				...
				pikmin.move(Johnny.locx, Johnny.locy, x);				
...
//				cout << pikmin.locx << " " << pikmin.locy; checking stuff, left it in to show that(deleted alot of debugging tools)
				...
				if(mazes[level].tiles[Johnny.locx][Johnny.locy + 1] == 'G' || mazes[level].tiles[Johnny.locx + 1][Johnny.locy] == 'G' || mazes[level].tiles[Johnny.locx - 1][Johnny.locy] == 'G' || mazes[level].tiles[Johnny.locx][Johnny.locy - 1] == 'G' ){
